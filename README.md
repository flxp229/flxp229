...
<ul>
  ...
  <li>View my first website: <a href="https://iql1pt.mimo.run">iql1pt.mimo.run</a>. Note: This site is created with an app I used for learning to code at the beginning.
</ul>
